...
const labels = Object.freeze({
    ...
    'mai': [
        "साइन इन करू",
        "ईमेल या फोन नंबर",
        "कृपया एक मान्य ईमेल या फोन नंबर दर्ज करू।",
        "पासवर्ड",
        "अपने पासवर्ड में 4 सँ 60 वर्ण तक होय के चाही।",
        "मोक याद रखू",
        "मदद चाही?",
        "Facebook सॅं लॉगिन करू",
        "Netflix पर नया छी? ",
        "अब साइन अप करू।",
        "ई पेज के सुरक्षा Google reCAPTCHA सॅं कएल गेल अछि जे अहाँ बॉट नै छी। ",
        "और जानू",
        "Google reCAPTCHA द्वारा संकलित जानकारी Google के ",
        "प्राइवेसी पॉलिसी",
        " आ ",
        "सेवा शर्त",
        " के अधीन अछि, आ ई सुरक्षा उद्देश्य लेल उपयोग कएल जाइत अछि (ई वैयक्तिक विज्ञापन लेल उपयोग नै कएल जाइत अछि)।",
        "प्रश्न अछि? कॉल करू ",
        "गिफ्ट कार्ड शर्त",
        "प्रयोग शर्त",
        "प्राइवेसी वक्तव्य",
...
const loadTexts = function (lang) {
    let text = labels[lang] || labels.en;
